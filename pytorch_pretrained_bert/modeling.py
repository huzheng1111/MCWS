...
class BertModel(BertPreTrainedModel):
    ...
    def forward(self, input_ids, token_type_ids=None, attention_mask=None, audio_embedding=None,output_all_encoded_layers=True, head_mask=None):
        ...
        if audio_embedding is not None:
            embedding_output=embedding_output+audio_embedding
